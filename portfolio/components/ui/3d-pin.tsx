    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2  flex justify-start items-start  rounded-2xl  dark:shadow-xl shadow-lg border dark:border-white/10 border-black/10 group-hover/pin:border-white/[0.2] transition duration-700 overflow-hidden"
        >
      ...
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          <div
            // href={href}
            // target={"_blank"}
            className="relative flex space-x-2 items-center z-10 rounded-full dark:bg-zinc-950 bg-gray-800 py-0.5 px-4 ring-1 ring-white/10 "
          >
